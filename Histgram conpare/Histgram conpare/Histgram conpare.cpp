// Histgram conpare.cpp : 定义控制台应用程序的入口点。
//
...
#define WINDOWS_NAME1 "【基准图像】"
#define WINDOWS_NAME2 "【测试图像1】"
#define WINDOWS_NAME3 "【测试图像2】"
...
int main()
{
	...
	//显示载入的3张图像
	imshow(WINDOWS_NAME1,srcImage_base);
	imshow(WINDOWS_NAME2, srcImage_test1);
	imshow(WINDOWS_NAME3, srcImage_test2);

	//将图像由BRG色彩空间转化到HSV色彩空间
	cvtColor( srcImage_base, hsvImage_base, COLOR_BGR2HSV);
	cvtColor(srcImage_test1, hsvImage_test1, COLOR_BGR2HSV);
	cvtColor(srcImage_test2, hsvImage_test2, COLOR_BGR2HSV);

	//创建包含基准图像下半部的半身图像（HSV）
